            ...
            <div class="modal " v-if="serviceModalDisplay" >
                <ul>
                    ...
                    <li>
                        ...
                        <p class="item-detail">活动结束后15天内若发生降价,可举证申请保险理赔.部分场景下不支持理赔(如双十一活动订单等),具体理赔范围详见【帮助中心-聚划算保价险服务】</p>
                    </li>
                    <li>
                ...
                <div class="sku-list-wrap">
                    <ul>
                        <li v-for="(items,index_i) in detail.paramSelect.data" :key="index_i">
                            ...
                            <div>
                                <div class="item" :class="[index_j == 0 ? 'itemSelect':'']" 
                        ...
                        <li class="amount">
                            ...
                            <el-input-number v-model="cartSelectAmount" @change="cartSelectAmountChange" :min="1" :max="10" label="购买数量"></el-input-number>
                        </li>
                    </ul>
                </div>
